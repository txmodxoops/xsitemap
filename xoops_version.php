 ...
 */
    ...
    $modversion["credits"] = "astueo.com (CSS Stylesheet), Mage, Mamba, Timgno";
    ...
    //Templates
    $i = 1;
    $modversion['templates'][$i]['file'] = 'xsitemap_index.tpl';
    $modversion['templates'][$i]['description'] = '';
    ++$i;

    $modversion['templates'][$i]['file'] = 'xsitemap_slickmap.tpl';
    $modversion['templates'][$i]['description'] = '';
    ++$i;

    $modversion['templates'][$i]['file'] = 'xsitemap_style.tpl';
    $modversion['templates'][$i]['description'] = '';
    ++$i;

    $modversion['templates'][$i]['file'] = 'xsitemap_xml.tpl';
    $modversion['templates'][$i]['description'] = '';
    ++$i;
